     ...
     <v-container fluid class="indigo darken-4 white--text" id="container">
        <v-layout text-left wrap> 
            ...
            <v-flex xs12 sm4 md2 lg4>
                <h1 class="pt-12">로그인</h1>                
            </v-flex>
            <v-flex xs10 sm4 md2 lg4 class="pl-10 mt-5">
                <v-text-field :rules="rules" color="white" placeholder="ID" id="input__form"></v-text-field>
                <v-text-field :rules="rules" color="white" placeholder="PWD" id="input__form"></v-text-field>
            </v-flex> 
